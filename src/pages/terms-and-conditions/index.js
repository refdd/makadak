...
export default function TermsAndConditions(params) {
  ...
  />
      ...
      <p>
        Welcome to <b>Mazadak!</b>
      </p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of <b>Mazadak&apos;s</b> Website, located at <b>Mazadak.com</b>
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use <b>Mazadak</b> if you do not agree to
      ...
      <p>
        ...
        &lsquo;Client&lsquo;, &lsquo;You&lsquo; and &lsquo;Your&lsquo; refers to
        you, the person log on this website and compliant to the Company&apos;s
        terms and conditions. &lsquo;The Company&lsquo;,
        &lsquo;Ourselves&lsquo;, &lsquo;We&lsquo;, &lsquo;Our&lsquo; and
        &lsquo;Us&lsquo;, refers to our Company. &lsquo;Party&lsquo;,
        &lsquo;Parties&lsquo;, or &lsquo;Us&lsquo;, refers to both the Client
        ...
        prevailing law of sa. Any use of the above terminology or other words in
      ...
      <p>
        We employ the use of cookies. By accessing <b>Mazadak</b> you agreed to
        use cookies in agreement with the <b>Mazadak&apos;s</b> Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, <b>Mazadak</b> and/or its licensors own the
        intellectual property rights for all material on <b>Mazadak</b> All
        intellectual property rights are reserved. You may access this
        from&nbsp;
        <b>Mazadak</b> for your own personal use subjected to restrictions set
      ...
      <ul>
        <li>
          Republish material from <b>Mazadak</b>
        </li>
        <li>
          Sell, rent or sub-license material from <b>Mazadak</b>
        </li>
        <li>
          Reproduce, duplicate or copy material from <b>Mazadak</b>
        </li>
        <li>
          Redistribute content from <b>Mazadak</b>
        </li>
      </ul>
      ...
      <p>
        ...
        <b>Mazadak</b> does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of <b>Mazadak</b> its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, <b>Mazadak</b>
      ...
      <p>
        <b>Mazadak</b> reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant <b>Mazadak</b> a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of <b>Mazadak</b> and (d) the link
      ...
      <p>
        ...
        e-mail to <b>Mazadak</b> Please include your name, your organization
      ...
      <p>
        No use of <b>Mazadak&apos;s</b> logo or other artwork will be allowed
